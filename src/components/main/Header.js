    ...
    <>
      ...
      className='relative z-5 flex flex-col justify-center items-center gap-4'>
            ...
            <div className='mt-3 flex justify-center items-center gap-3'>
                ...
                <a className='px-2 md:px-4 md:py-2 py-1 md:text-[20px] text-[18px] rounded-full border border-2-white hover:bg-gradient-to-tr hover:from-[#6439ff] hover:to-[#4f75ff] transition-all duration-[2s] ease-in-out text-white font-varun' href="https://youtu.be/_kqG3avdv3s?si=mC7VuaE_x5KANIme" target="_blank" rel="noopener noreferrer">Watch Intro</a>
            </div>
        </motion.div>
        <img
